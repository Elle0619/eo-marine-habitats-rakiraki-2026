...
<img width="800" height="310" alt="image" src="https://github.com/Elle0619/eo-marine-habitats-rakiraki-2026/blob/main/course-mrd.png?raw=true" /> -->
...
<!-- <img width="750" height="410" alt="image" src="[https://github.com/user-attachments/assets/69656724-9140-4eff-8714-637ee96704bf](https://github.com/Elle0619/eo-marine-habitats-rakiraki-2026/blob/main/course-mrd.png?raw=true)" /> -->
...
## Rationale
 
This one-day training workshop provides participants with practical exposure to Earth Observation (EO), Geographic Information Systems (GIS), and machine learning applications for environmental monitoring. The workshop focuses on introducing Digital Earth Pacific (DEP) and EO-GPT platforms, enabling participants to set up accounts, access geospatial data, and apply machine learning techniques for marine habitat classification.

The training is deliberately practice-oriented: students will set up the required platforms, undertake laboratory exercises, collect field data using QField, process and incorporate field observations into Digital Earth Pacific, apply machine learning classification workflows, analyse change detection outputs and present their applied findings. 
...
- Post-process trained data and incorporate it into Digital Earth Pacific. 
- Describe classifiers and machine learning concepts and apply a machine learning classification workflow. 
- Generate and interpret change detection and statistics outputs relevant to coastal monitoring impact applications. 
...
## Expected Outcomes 
- Participants understand how Earth Observation (EO), satellite imagery, and Digital Earth Pacific can support marine habitat mapping and coastal monitoring applications.
- Participants gain practical experience using Digital Earth Pacific, EO-GPT, GitHub, and cloud-based geospatial analysis tools and workflows.
- Participants complete introductory Python and machine learning classification activities for marine habitat mapping using Earth Observation data.
- Participants generate, evaluate, and interpret marine habitat classification outputs, including habitat maps, accuracy assessments, and habitat statistics.
...
For those prarticipants seeking to stay connected and learn more about the content of this course and further opportunities please join and follow: 
